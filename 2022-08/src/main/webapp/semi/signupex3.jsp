...
<link rel="stylesheet" type='text/css' href='signupex3.css'>
</head>
<body>
<form action="doJoin" method="POST" class="joinForm">
      ...
      <div class="textForm">
       ...
       <div class="textForm">
        <input name="email" type="text" class="address" placeholder="주소">
      </div>
      <div class="textForm">
        <input name="nickname" type="text" class="email" placeholder="이메일">
      </div>
      <div class="textForm">
