 ...
 */
let data=[
	{'id' : 'a001', 'name' : 'hong', 'gender' :'m', 'phone':'010-7372-5818'},
	{'id' : 'b001', 'name' : 'kim', 'gender' :'f', 'phone':'010-5628-7712'},
	{'id' : 'c001', 'name' : 'lee', 'gender' : 'f', 'phone':'010-5555-2223'}
];
let template;
list();
function list(){
...
function add(frm){
	...
	*/
	...
	v={
	'id':frm.id.value, 'name':frm.name.value,
...
function update(frm){
	...
	if(index>=0){ //수정할 데이터가 있는 경우
		...
		date[index].phone = frm.phone.value;
		data[index].gender = g;
		list();
		alert('데이터가 수정되었습니다.');
	}else{
